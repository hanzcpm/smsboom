...
async def start_command(update: Update, context: CallbackContext):
    ...
    await update.message.reply_animation(
        ...
        caption=(
            ...
            "🚀 *Ready to explore Kenshiruuu premium bot?*\n\n"
            "🔑 `/key <your_key>` — *Enter your access pass!*\n"
            "🎲 `/generate` — *Open the generator panel!*\n\n"
            "✨ *Get ready to unleash unlimited combos!* ✨\n\n"
            "_Powered by Kenshiruuu premium bot_ ⚡"
        ),
        parse_mode="Markdown"
    )
...
async def generate_proxies(update: Update, context: CallbackContext, count: int):
    ...
    with open(filename, "w", encoding="utf-8") as f:
        f.write("✅ File Generated via Kenshiruuu premium bot\n")
        f.write("📄 File: proxy\n")
        f.write("🔥 Type: Mix\n")
    ...
    with open(filename, "rb") as f:
        await query.message.reply_document(
            ...
            caption=f"✅ *File Generated via Kenshiruuu premium bot*\n📄 *File:* proxy\n🔥 *Type:* Mix\n📈 *Lines:* {len(selected_proxies)}",
            parse_mode="Markdown"
        )
...
async def confirm_vip_generate(update, context):
    ...
    with open(out_file, "w", encoding="utf-8") as f:
        f.write("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
        f.write("      ★ VIP DROP — Kenshiruuu premium bot ★\n")
        f.write("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
        ...
        f.write("\nGenerated by Kenshiruuu premium bot\n")
    ...
    with open(out_file, "rb") as f:
        await query.message.reply_document(
            ...
            caption=(
                ...
                f"🕒 Date: *{timestamp}*\n"
                f"🆔 File ID: `{file_id}`\n\n"
                f"🔐 _Generated by Kenshiruuu premium bot_"
            ),
            parse_mode="Markdown"
        )
...
def get_random_lines(filename, num_lines):
    try:
        ...
        # === CONFIGURATION ===
TOKEN = "8230827819:AAGl0XuOXU_KpAreAsYxqr7vJv4-z4Q-hxo"  # Palitan ng iyong bot token
ADMIN_ID = 8234048707  # Palitan ng iyong Telegram ID
DATABASE_FILES ={
  "100082": "100082.txt",
  "8BALL": "8BALL.txt",
  "Amazon": "Amazon.txt",
...
async def generate_key(update: Update, context: CallbackContext):
    ...
    await update.message.reply_animation(
        ...
        caption=(
            ...
            "*Kenshiruuu premium bot — Code. Access. Conquer.*"
...
async def generate_menu(update: Update, context: CallbackContext):
    ...
    await update.message.reply_animation(
        animation=gif_url,
        caption=(
            f"🎉 Welcome {user.mention_markdown()} to *Kenshiruuu premium bot!*\n\n"
...
async def handle_logs_generation(update: Update, context: CallbackContext):
    ...
    try:
        ...
        output_file = "Vince_Logs_Vip.txt"
        ...
        with open(output_file, "w", encoding="utf-8") as f:
            f.write("🔥 Kenshiruu Logs Generator 🔥\n")
            f.write("Made using VinceGen Bot\n")
            f.write("=================================\n\n")
        ...
        with open(output_file, "rb") as f:
            await query.message.reply_document(
                ...
                caption=(
                    ...
                    f"📂 *Filename:* Vince_Logs_Vip.txt\n"
                    f"📏 *Size:* {size_mb}MB\n"
                    f"📜 *Lines:* {len(selected_lines)}\n\n"
                    f"_Made using VinceGen Bot_"
                ),
                parse_mode="Markdown"
            )
...
async def show_logs_menu(update: Update, context: CallbackContext):
    ...
    await query.message.edit_text(
        "📝 *Welcome to Vince Logs Generator!*\n\nChoose a file size to generate:",
        parse_mode="Markdown",
        reply_markup=InlineKeyboardMarkup(keyboard)
    )
import os
...
async def handle_name_command(update: Update, context: CallbackContext):
    ...
    with open(output_filename, "w", encoding="utf-8") as file:
        file.write("🔖 Kenshiruuu premium bot File\n\n")
...
def format_uptime():
    ...
    text = (
        ...
        f"\n<em>Updated live with Kenshiruuu premium bot</em>"
    )
    return text
...
async def handle_search_command(update: Update, context: CallbackContext):
    ...
    with open(temp_filename, "w", encoding="utf-8") as f:
        f.write("🔎 Search Results by Kenshiruuu premium bot\n")
...
async def announcement_message_handler(update: Update, context: CallbackContext):
    ...
    if user_id in awaiting_announcement:
        ...
        await update.message.reply_text(
            ...
            "• 1 Week — 100 PHP\n"
            "• Lifetime — 200 PHP\n\n"
            "To get your key, send proof of payment to *@Kenshirupogi*"
...
async def handle_help(update: Update, context: CallbackContext):
    await context.bot.send_animation(
        ...
        caption=(
            ...
            "⚙️ _Powered by Kenshiruuu premium bot_"
        ),
        parse_mode="Markdown"
    )
...
async def show_total_generated(update: Update, context: CallbackContext):
    try:
        ...
        msg = "📊 *Kenshiruuu premium bot - Total Generated Summary:*\n\n"
...
async def database_menu(update: Update, context: CallbackContext, page=0):
    ...
    await update.callback_query.message.edit_text(
        f"👋 *Hello {username}!* \n"
        f"📡 *Welcome To KENSHIRUU Premium Bot*\n"
...
async def confirm_generate(update: Update, context: CallbackContext):
    ...
    with open(result_file, "w", encoding="utf-8") as f:
        f.write(
            f"🔹Generated by Kenshiruuu premium bot\n"
            f"📅 Date: {timestamp}\n"
            f"🎮 Source : {game}\n"
    ...
    try:
        ...
        if data == "database_menu":
            ...
            await query.message.edit_text(
                ...
                "_Powered by Kenshiruu Premium Bot_",
                parse_mode="Markdown"
            )
